...
<div class="container mt-4">
    <div class="card shadow">
        <div class="card-header bg-secondary text-primary small d-flex justify-content-between align-items-center">
            <span class="h6 text-info">Cinem@s</span>
            <button type="button" class="btn-close" aria-label="Close"></button>
        </div>
        <div class="card-body">
            <form method="post" action="../../Views/Accion/formAccion.php" class="needs-validation" novalidate enctype="multipart/form-data">
            ...
            <?php if (!empty($peliculaIngresada)): ?>
                <div class="alert alert-success mt-4">
                    ...
                    <?php if(!empty($peliculaIngresada['imagen'])): ?>
                        <img src="../../<?php echo $peliculaIngresada['imagen']; ?>" alt="Imagen película" class="img-fluid mb-3" style="max-height:200px;">
                    <?php endif; ?>

                    <ul class="list-unstyled text-success">
                        <?php foreach ($peliculaIngresada as $key => $value): ?>
                            <?php if($key !== 'titulo' && $key !== 'imagen'): ?>
